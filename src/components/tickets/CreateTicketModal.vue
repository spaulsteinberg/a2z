    ...
    >
        ...
        <div class="input-create-container">
            <div class="create-ticket-input">
                <AZInputGroup type="number" v-model="basePay" id="basePay" labelText="Base Pay: " :handleBlur="v.basePay.$touch" :isInvalid="v.basePay.$error" alignInput="text-end"/>
            ...
            <div class="create-ticket-input-sm">
                <AZInputGroup type="number" v-model="ratePerMile" id="ratePerMile" labelText="Rate/Mile: " step="any" :handleBlur="v.ratePerMile.$touch" :isInvalid="v.ratePerMile.$error" alignInput="text-end" />
        ...
        <template #footer>
            <div class="text-center">
                ...
                <button class="btn btn-primary mx-1" @click="handleCreateTicket">Create</button>
            </div>
        </template>    
    </ElDialog>
</template>
...
import { AZInputGroup, AZErrorBlock, AZTextarea } from "../utility"
...
export default {
    ...
    components: { ElDialog, AZInputGroup, AZErrorBlock, AZTextarea },
    props: {
        data: {
            type: Object,
            required: true,
    ...
    setup(props, context){
        ...
        return {
            show, handleCreateTicket, handleClose, ...toRefs(ticketForm), total, isLargerScreen, isDesktop, v
        }
    },
    emits: ["closeModal"]
}
