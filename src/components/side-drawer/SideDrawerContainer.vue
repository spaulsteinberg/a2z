<template>
  <div class="source-dest-container">
    <AZInputGroup v-model.trim="source" id="source-loc" placeholder="Enter your starting point" labelText="Start: "
      hasMargin />
    <button class="btn swap-btn" @click="handleSwapLocations">
      <SwapIcon fill="white" />
    </button>
    <AZInputGroup v-model.trim="destination" id="destination-loc" placeholder="Choose your destination"
      labelText="Destination: " :hasMargin="false" />
    ...
    <div class="ticket-container my-5">
      ...
      <template v-else>
        <button class="btn btn-info text-light" @click="showRecentTickets = !showRecentTickets"
          v-if="!showRecentTickets">Show Recent Tickets</button>
        <button class="btn btn-secondary" @click="showRecentTickets = !showRecentTickets" v-else>Hide Recent
          Tickets</button>
        <div class="my-5">
